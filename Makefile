...
am_libSnnDL_la_OBJECTS = SnnPE.lo SnnPESubComponent.lo SpikeSource.lo \
	...
	GatherBufferIF.lo MemKCalBench.lo MPITypes.lo \
	MPIMultiCorePE.lo
...
AMTAR = $${TAR-tar}
AM_CFLAGS =  
AM_CPPFLAGS =  -I/usr/include/python3.10 -I/usr/include/python3.10 -I/home/xgy/remote/sst_install/include/sst/core -I/home/xgy/remote/sst_install/include -I$(top_srcdir)/src \
...
# GAS scratchpad StandardMem front-end

# Micro-benchmark component for k calibration
...
libSnnDL_la_SOURCES = SnnPE.cc SnnPE.h SnnCoreAPI.h \
	...
	GatingPE.h GatingDecisionEvent.h GatherBufferIF.cc \
	GatherBufferIF.h GasCustomCmd.h MemKCalBench.cc MemKCalBench.h \
	MPITypes.h MPITypes.cc MPIMultiCorePE.h MPIMultiCorePE.cc
...
include ./$(DEPDIR)/MPITypes.Plo # am--include-marker
include ./$(DEPDIR)/MemKCalBench.Plo # am--include-marker
include ./$(DEPDIR)/MultiCorePE.Plo # am--include-marker
...
include ./$(DEPDIR)/SnnPESubComponent.Plo # am--include-marker
include ./$(DEPDIR)/SpikeEventWrapper.Plo # am--include-marker
include ./$(DEPDIR)/SpikeSource.Plo # am--include-marker
include ./$(DEPDIR)/WeightLoader.Plo # am--include-marker
...
distclean: distclean-am
	...
	-rm -f ./$(DEPDIR)/MemKCalBench.Plo
	-rm -f ./$(DEPDIR)/MultiCorePE.Plo
	...
	-rm -f ./$(DEPDIR)/SnnPESubComponent.Plo
	-rm -f ./$(DEPDIR)/SpikeEventWrapper.Plo
	-rm -f ./$(DEPDIR)/SpikeSource.Plo
	-rm -f ./$(DEPDIR)/WeightLoader.Plo
	-rm -f Makefile
