...
am_libSnnDL_la_OBJECTS = events/SimpleTestEvent.lo \
	...
	components/GatherBufferIF.lo components/GatingPE.lo \
	components/MemKCalBench.lo components/MultiCorePE.lo \
	components/SnnNIC.lo components/SnnPE.lo \
	components/stimulus/SpikeSource.lo components/WeightLoader.lo \
	components/mpi/MPIMultiCorePE.lo components/mpi/MPITypes.lo \
...
am__depfiles_remade = components/$(DEPDIR)/GatherBufferIF.Plo \
...
AM_CPPFLAGS =  -I/usr/include/python3.10 -I/usr/include/python3.10 -I/home/xgy/remote/sst_install/include/sst/core -I/home/xgy/remote/sst_install/include -I$(top_srcdir)/src -I$(srcdir) \
	...
	-I$(srcdir)/components/mpi -I$(srcdir)/control \
	-I$(srcdir)/compute -I$(srcdir)/services \
...
components/mpi/$(am__dirstamp):
	@$(MKDIR_P) components/mpi
	@: > components/mpi/$(am__dirstamp)
components/mpi/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) components/mpi/$(DEPDIR)
	@: > components/mpi/$(DEPDIR)/$(am__dirstamp)
components/mpi/MPIMultiCorePE.lo: components/mpi/$(am__dirstamp) \
	components/mpi/$(DEPDIR)/$(am__dirstamp)
components/mpi/MPITypes.lo: components/mpi/$(am__dirstamp) \
	components/mpi/$(DEPDIR)/$(am__dirstamp)
