...
public:
    ...
    SST_ELI_DOCUMENT_PARAMS(
        ...
        {"defer_issue_until_apply", "defer issuing downstream reads until APPLY stage", "1"},
        ...
        {"manual_window_drive", "expect external component to tick window_auto state machine manually", "0"},
