...
sst.setStatisticOutputOptions({"filepath": "./neuron_dynamics_2x2_lif_stats.csv", "separator": ","})
...
spike_file = os.path.join(base_dir, "spikes_pe0.txt")
...
link = sst.Link("spike_source_0_to_pe_0")
link.connect((src, "spike_output", "5ns"), (nodes[0], "external_spike_input", "5ns"))

# stats per node/router
for n in nodes:
