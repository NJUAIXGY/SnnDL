...
public:
    ...
    // Optional providers are registered by extension libraries. The core PE
    // can therefore assemble without linking a concrete runtime bridge.
    virtual void configureFromParams(const SST::Params& /*params*/) {}
    virtual void bindRuntime(const ICoreWorkload::Runtime& /*rt*/) {}
