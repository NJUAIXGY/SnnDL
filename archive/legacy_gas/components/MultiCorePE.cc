...
SST::SnnDL::IPeDiagnosticsSink*
MultiCorePE::CapabilityAdapter::peDiagnosticsSink() {
    return this;
}

SST::SnnDL::IPeRuntimeConfig*
MultiCorePE::CapabilityAdapter::peRuntimeConfig() {
    return this;
}

SST::SnnDL::IDmaSchedulerProvider*
MultiCorePE::CapabilityAdapter::dmaSchedulerProvider() {
    return this;
}

SST::SnnDL::ILocalStorageProvider*
MultiCorePE::CapabilityAdapter::localStorageProvider() {
    return this;
}

SST::SnnDL::IPePodSharedMetadataProvider*
MultiCorePE::CapabilityAdapter::podMetadataProvider() {
    return this;
}

SST::SnnDL::IPeWeightObjectPlaneProvider*
MultiCorePE::CapabilityAdapter::weightObjectPlaneProvider() {
    return this;
}

SST::Statistics::Statistic<uint64_t>*
MultiCorePE::CapabilityAdapter::getComputeActiveCyclesTotalStatistic() const {
    return owner_.getComputeActiveCyclesTotalStatistic();
}

void MultiCorePE::CapabilityAdapter::recordStepGasStat(
    uint32_t seq, const GasStatEvent& st) {
    owner_.recordStepGasStat(seq, st);
}

void MultiCorePE::CapabilityAdapter::recordCoreStepGasStat(
    int core_id, uint32_t seq, const GasStatEvent& st) {
    owner_.recordCoreStepGasStat(core_id, seq, st);
}

void MultiCorePE::CapabilityAdapter::recordStepApplyScatter(
    uint32_t seq, uint64_t acc_updates, uint64_t posts_touched,
    uint64_t spikes_emitted, uint64_t hwm_bytes, uint64_t spill_records,
    uint64_t spilled_bytes) {
    owner_.recordStepApplyScatter(seq, acc_updates, posts_touched,
                                   spikes_emitted, hwm_bytes, spill_records,
                                   spilled_bytes);
}

void MultiCorePE::CapabilityAdapter::recordCoreStepApplyScatter(
    int core_id, uint32_t seq, uint64_t acc_updates, uint64_t posts_touched,
    uint64_t spikes_emitted, uint64_t hwm_bytes, uint64_t spill_records,
    uint64_t spilled_bytes) {
    owner_.recordCoreStepApplyScatter(core_id, seq, acc_updates, posts_touched,
                                      spikes_emitted, hwm_bytes, spill_records,
                                      spilled_bytes);
}

void MultiCorePE::CapabilityAdapter::accumulateRiscvSnnRuntimeStats(
    uint64_t workload_selected, uint64_t firmware_elf_present,
    uint64_t firmware_loaded, uint64_t backend_runtime_bridge,
    uint64_t firmware_started_count, uint64_t submitted_commands,
    uint64_t accepted_commands, uint64_t completion_visible_count,
    uint64_t completion_consumed_count, uint64_t fused_step_completion_count,
    uint64_t fault_count, uint64_t last_completion_status,
    uint64_t last_fault_csr, uint64_t backend_runtime_bridge_provider_bound) {
    owner_.accumulateRiscvSnnRuntimeStats(
        workload_selected, firmware_elf_present, firmware_loaded,
        backend_runtime_bridge, firmware_started_count, submitted_commands,
        accepted_commands, completion_visible_count, completion_consumed_count,
        fused_step_completion_count, fault_count, last_completion_status,
        last_fault_csr, backend_runtime_bridge_provider_bound);
}

PeDmaScheduler* MultiCorePE::CapabilityAdapter::dmaScheduler() {
    return owner_.dmaScheduler();
}

LocalStorageHierarchyController*
MultiCorePE::CapabilityAdapter::localStorageHierarchy() {
    return owner_.localStorageHierarchy();
}

PodMetadataObjectPlane*
MultiCorePE::CapabilityAdapter::pePodMetadataObjectPlane() {
    return owner_.pePodMetadataObjectPlane();
}

PodOwnerServiceTable*
MultiCorePE::CapabilityAdapter::pePodOwnerServiceTable() {
    return owner_.pePodOwnerServiceTable();
}

PeLocalServiceObjectTable*
MultiCorePE::CapabilityAdapter::peLocalServiceObjectTable() {
    return owner_.peLocalServiceObjectTable();
}

PeWeightObjectPlane*
MultiCorePE::CapabilityAdapter::peWeightObjectPlane() {
    return owner_.peWeightObjectPlane();
}

bool MultiCorePE::CapabilityAdapter::peInternalCpeEnabledConfig() const {
    return owner_.peInternalCpeEnabledConfig();
}

bool MultiCorePE::CapabilityAdapter::peInternalPodEnabledConfig() const {
    return owner_.peInternalPodEnabledConfig();
}

bool MultiCorePE::CapabilityAdapter::peInternalPodMetadataEnabledConfig() const {
    return owner_.peInternalPodMetadataEnabledConfig();
}

bool MultiCorePE::CapabilityAdapter::peInternalPodOwnerEnabledConfig() const {
    return owner_.peInternalPodOwnerEnabledConfig();
}

uint32_t MultiCorePE::CapabilityAdapter::peInternalPodCountConfig() const {
    return owner_.peInternalPodCountConfig();
}

uint32_t MultiCorePE::CapabilityAdapter::peInternalPodSizeConfig() const {
    return owner_.peInternalPodSizeConfig();
}

PeDmaScheduler* MultiCorePE::dmaScheduler() {
    return optional_services_ ? optional_services_->dmaScheduler() : nullptr;
}

LocalStorageHierarchyController* MultiCorePE::localStorageHierarchy() {
    return optional_services_ ? optional_services_->localStorageHierarchy() : nullptr;
}

const LocalStorageHierarchyController* MultiCorePE::localStorageHierarchy() const {
    return optional_services_ ? optional_services_->localStorageHierarchy() : nullptr;
}

PodMetadataObjectPlane* MultiCorePE::pePodMetadataObjectPlane() {
    return optional_services_ ? optional_services_->podMetadataObjectPlane() : nullptr;
}

PodOwnerServiceTable* MultiCorePE::pePodOwnerServiceTable() {
    return optional_services_ ? optional_services_->podOwnerServiceTable() : nullptr;
}

PeLocalServiceObjectTable* MultiCorePE::peLocalServiceObjectTable() {
    return optional_services_ ? optional_services_->localServiceObjectTable() : nullptr;
}

PeWeightObjectPlane* MultiCorePE::peWeightObjectPlane() {
    return optional_services_ ? optional_services_->weightObjectPlane() : nullptr;
}

bool MultiCorePE::peInternalCpeEnabledConfig() const {
    return pe_internal_cpe_enable_cfg_;
}

bool MultiCorePE::peInternalPodEnabledConfig() const {
    return pe_internal_pod_enable_cfg_;
}

bool MultiCorePE::peInternalPodMetadataEnabledConfig() const {
    return pe_internal_pod_metadata_enable_cfg_;
}

bool MultiCorePE::peInternalPodOwnerEnabledConfig() const {
    return pe_internal_pod_owner_enable_cfg_;
}

uint32_t MultiCorePE::peInternalPodCountConfig() const {
    return pe_internal_pod_count_cfg_;
}

uint32_t MultiCorePE::peInternalPodSizeConfig() const {
    return pe_internal_pod_size_cfg_;
}

MultiCorePE::MultiCorePE(ComponentId_t id, Params& params)
    : Component(id), core_params_template_(params), capabilities_(*this) {
    ...
    optional_services_ = std::make_unique<PeOptionalServices>();
    const PeOptionalServicesState optional_state = optional_services_->configure(
        cfg, pure_snn_datapath_workload_eligible_, num_cores_, node_id_, output_);
    pe_internal_cpe_enable_cfg_ = optional_state.pe_internal_cpe_enable;
    pe_internal_pod_enable_cfg_ = optional_state.pe_internal_pod_enable;
    pe_internal_pod_metadata_enable_cfg_ = optional_state.pe_internal_pod_metadata_enable;
    pe_internal_pod_owner_enable_cfg_ = optional_state.pe_internal_pod_owner_enable;
    pe_internal_pod_count_cfg_ = optional_state.pe_internal_pod_count;
    pe_internal_pod_size_cfg_ = optional_state.pe_internal_pod_size;
...
void MultiCorePE::finish() {
    ...
    if (dmaScheduler()) {
        const auto dma_stats = dmaScheduler()->snapshotStats();
    ...
    if (localStorageHierarchy()) {
        const auto ls_stats = localStorageHierarchy()->snapshotStats();
...
void MultiCorePE::accumulateSynapseReadStats(
    ...
    if (stat_weight_read_dense_reqs_total_) {
        stat_weight_read_dense_reqs_total_->addData(dense_reqs_total);
    }
    if (stat_weight_read_dense_bytes_total_) {
        stat_weight_read_dense_bytes_total_->addData(dense_bytes_total);
    }
    if (stat_weight_read_rowptr_reqs_total_) {
        stat_weight_read_rowptr_reqs_total_->addData(rowptr_reqs_total);
    }
    if (stat_weight_read_rowptr_bytes_total_) {
        stat_weight_read_rowptr_bytes_total_->addData(rowptr_bytes_total);
    }
    if (stat_weight_read_colidx_reqs_total_) {
        stat_weight_read_colidx_reqs_total_->addData(colidx_reqs_total);
    }
    if (stat_weight_read_colidx_bytes_total_) {
        stat_weight_read_colidx_bytes_total_->addData(colidx_bytes_total);
    }
    if (stat_weight_read_blockdata_reqs_total_) {
        stat_weight_read_blockdata_reqs_total_->addData(blockdata_reqs_total);
    }
    if (stat_weight_read_blockdata_bytes_total_) {
        stat_weight_read_blockdata_bytes_total_->addData(blockdata_bytes_total);
    }

    if (stat_weight_idx_sram_reads_total_) {
        stat_weight_idx_sram_reads_total_->addData(weight_idx_sram_reads_total);
    }
    if (stat_weight_idx_sram_writes_total_) {
        stat_weight_idx_sram_writes_total_->addData(weight_idx_sram_writes_total);
    }
    if (stat_weight_idx_sram_bytes_read_total_) {
        stat_weight_idx_sram_bytes_read_total_->addData(weight_idx_sram_bytes_read_total);
    }
    if (stat_weight_idx_sram_bytes_write_total_) {
        stat_weight_idx_sram_bytes_write_total_->addData(weight_idx_sram_bytes_write_total);
    }
    if (stat_weight_idx_sram_bank_conflict_ticks_total_) {
        stat_weight_idx_sram_bank_conflict_ticks_total_->addData(
            weight_idx_sram_bank_conflict_ticks_total);
    }
    if (stat_weight_idx_sram_predicted_extra_cycles_total_) {
        stat_weight_idx_sram_predicted_extra_cycles_total_->addData(
            weight_idx_sram_predicted_extra_cycles_total);
    }
    if (stat_weight_idx_sram_resident_bytes_peak_) {
        stat_weight_idx_sram_resident_bytes_peak_->addData(
            weight_idx_sram_resident_bytes_peak);
    }
    if (stat_weight_idx_sram_bank_peak_accesses_per_tick_) {
        stat_weight_idx_sram_bank_peak_accesses_per_tick_->addData(
            weight_idx_sram_bank_peak_accesses_per_tick);
    }
    if (stat_weight_idx_sram_energy_read_pj_total_) {
        stat_weight_idx_sram_energy_read_pj_total_->addData(
            weight_idx_sram_energy_read_pj_total);
    }
    if (stat_weight_idx_sram_energy_write_pj_total_) {
        stat_weight_idx_sram_energy_write_pj_total_->addData(
            weight_idx_sram_energy_write_pj_total);
    }

    if (stat_weight_l0_sram_reads_total_) {
        stat_weight_l0_sram_reads_total_->addData(weight_l0_sram_reads_total);
    }
    if (stat_weight_l0_sram_writes_total_) {
        stat_weight_l0_sram_writes_total_->addData(weight_l0_sram_writes_total);
    }
    if (stat_weight_l0_sram_bytes_read_total_) {
        stat_weight_l0_sram_bytes_read_total_->addData(weight_l0_sram_bytes_read_total);
    }
    if (stat_weight_l0_sram_bytes_write_total_) {
        stat_weight_l0_sram_bytes_write_total_->addData(weight_l0_sram_bytes_write_total);
    }
    if (stat_weight_l0_sram_bank_conflict_ticks_total_) {
        stat_weight_l0_sram_bank_conflict_ticks_total_->addData(
            weight_l0_sram_bank_conflict_ticks_total);
    }
    if (stat_weight_l0_sram_predicted_extra_cycles_total_) {
        stat_weight_l0_sram_predicted_extra_cycles_total_->addData(
            weight_l0_sram_predicted_extra_cycles_total);
    }
    if (stat_weight_l0_sram_resident_bytes_peak_) {
        stat_weight_l0_sram_resident_bytes_peak_->addData(weight_l0_sram_resident_bytes_peak);
    }
    if (stat_weight_l0_sram_bank_peak_accesses_per_tick_) {
        stat_weight_l0_sram_bank_peak_accesses_per_tick_->addData(
            weight_l0_sram_bank_peak_accesses_per_tick);
    }
    if (stat_weight_l0_sram_energy_read_pj_total_) {
        stat_weight_l0_sram_energy_read_pj_total_->addData(weight_l0_sram_energy_read_pj_total);
    }
    if (stat_weight_l0_sram_energy_write_pj_total_) {
        stat_weight_l0_sram_energy_write_pj_total_->addData(weight_l0_sram_energy_write_pj_total);
    }
    if (stat_weight_sram_enforced_stall_cycles_total_) {
        stat_weight_sram_enforced_stall_cycles_total_->addData(
            weight_sram_enforced_stall_cycles_total);
    }
    if (stat_weight_l0_lookup_total_) {
        stat_weight_l0_lookup_total_->addData(weight_l0_lookup_total);
    }
    if (stat_weight_l0_hit_total_) {
        stat_weight_l0_hit_total_->addData(weight_l0_hit_total);
    }
    if (stat_weight_l0_fill_total_) {
        stat_weight_l0_fill_total_->addData(weight_l0_fill_total);
    }
    if (stat_weight_l0_evict_total_) {
        stat_weight_l0_evict_total_->addData(weight_l0_evict_total);
    }

    if (stat_core_state_sram_reads_total_) {
        stat_core_state_sram_reads_total_->addData(core_state_sram_reads_total);
    }
    if (stat_core_state_sram_writes_total_) {
        stat_core_state_sram_writes_total_->addData(core_state_sram_writes_total);
    }
    if (stat_core_state_sram_bytes_read_total_) {
        stat_core_state_sram_bytes_read_total_->addData(core_state_sram_bytes_read_total);
    }
    if (stat_core_state_sram_bytes_write_total_) {
        stat_core_state_sram_bytes_write_total_->addData(core_state_sram_bytes_write_total);
    }
    if (stat_core_state_sram_bank_conflict_ticks_total_) {
        stat_core_state_sram_bank_conflict_ticks_total_->addData(
            core_state_sram_bank_conflict_ticks_total);
    }
    if (stat_core_state_sram_predicted_extra_cycles_total_) {
        stat_core_state_sram_predicted_extra_cycles_total_->addData(
            core_state_sram_predicted_extra_cycles_total);
    }
    if (stat_core_state_sram_resident_bytes_peak_) {
        stat_core_state_sram_resident_bytes_peak_->addData(core_state_sram_resident_bytes_peak);
    }
    if (stat_core_state_sram_bank_peak_accesses_per_tick_) {
        stat_core_state_sram_bank_peak_accesses_per_tick_->addData(
            core_state_sram_bank_peak_accesses_per_tick);
    }
    if (stat_core_state_sram_energy_read_pj_total_) {
        stat_core_state_sram_energy_read_pj_total_->addData(core_state_sram_energy_read_pj_total);
    }
    if (stat_core_state_sram_energy_write_pj_total_) {
        stat_core_state_sram_energy_write_pj_total_->addData(core_state_sram_energy_write_pj_total);
    }
    if (stat_core_state_sram_stall_cycles_total_) {
        stat_core_state_sram_stall_cycles_total_->addData(core_state_sram_stall_cycles_total);
    }

    if (stat_gas_retire_global_hol_cycles_total_) {
        stat_gas_retire_global_hol_cycles_total_->addData(gas_retire_global_hol_cycles_total);
    }
    if (stat_gas_retire_ready_but_blocked_edges_total_) {
        stat_gas_retire_ready_but_blocked_edges_total_->addData(
            gas_retire_ready_but_blocked_edges_total);
    }
    if (stat_gas_retire_per_post_progress_total_) {
        stat_gas_retire_per_post_progress_total_->addData(gas_retire_per_post_progress_total);
    }
    if (stat_gas_retire_samepost_blocked_edges_total_) {
        stat_gas_retire_samepost_blocked_edges_total_->addData(
            gas_retire_samepost_blocked_edges_total);
    }
    if (stat_gas_retire_crosspost_blocked_edges_total_) {
        stat_gas_retire_crosspost_blocked_edges_total_->addData(
            gas_retire_crosspost_blocked_edges_total);
    }
    if (stat_gas_retire_policy_loss_cycles_total_) {
        stat_gas_retire_policy_loss_cycles_total_->addData(gas_retire_policy_loss_cycles_total);
    }
    if (stat_gas_retire_policy_loss_edges_total_) {
        stat_gas_retire_policy_loss_edges_total_->addData(gas_retire_policy_loss_edges_total);
    }
    if (stat_gas_retire_shadow_per_post_recoverable_cycles_total_) {
        stat_gas_retire_shadow_per_post_recoverable_cycles_total_->addData(
            gas_retire_shadow_per_post_recoverable_cycles_total);
    }
    if (stat_gas_retire_shadow_per_post_recoverable_edges_total_) {
        stat_gas_retire_shadow_per_post_recoverable_edges_total_->addData(
            gas_retire_shadow_per_post_recoverable_edges_total);
    }
    if (stat_gas_retire_shadow_per_post_ready_posts_peak_) {
        stat_gas_retire_shadow_per_post_ready_posts_peak_->addData(
            gas_retire_shadow_per_post_ready_posts_peak);
    }
    if (stat_gas_retire_shadow_per_post_committable_edges_peak_) {
        stat_gas_retire_shadow_per_post_committable_edges_peak_->addData(
            gas_retire_shadow_per_post_committable_edges_peak);
    }
}
...
void MultiCorePE::initializeProcessingUnits() {
    ...
    for (int i = 0; i < num_cores_; i++) {
        ...
        if (core) {
            ...
            core->setCapabilityProvider(&capabilities_);
